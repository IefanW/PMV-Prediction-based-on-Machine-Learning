...
dir = '/Users/iefan_wey/Desktop/毕业设计/BPNN/Implementation/LSTM_testing_data/7_1.csv'
...
data.drop(data.index[:48],inplace=True)

result = data
print(result.head())
print(result.shape)
result.to_csv(result.to_csv('/Users/iefan_wey/Desktop/毕业设计/BPNN/Implementation/LSTM_testing_data/data7_1.csv',index = False))